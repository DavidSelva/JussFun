package com.app.jussfun.View.Main;
...
import com.app.jussfun.Adapter.ArrayAdapterMatches;
import com.app.jussfun.Models.CardMatches;
import com.app.jussfun.Models.DataFire;
import com.app.jussfun.Models.Images;
import com.app.jussfun.R;
import com.app.jussfun.Utils.DialogUtils;
import com.app.jussfun.Utils.GPSTracker;
    ...
    private void checkMySearchPreferences(){
        ...
        dbMyIDusers.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.hasChild("genderMeet")){
                ...
                if (dataSnapshot.hasChild("max_age_meet") && dataSnapshot.hasChild("min_age_meet")){
